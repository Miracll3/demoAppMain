    ...
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="card border-0 bg-white shadow">
                <div class="card-header fw-bold border-0 bg-white fs-5 border-bottom py-3">{{ $category->name }}</div>

                <div class="card-header fw-bold border-0 bg-white fs-5 border-bottom py-3 mt-4">Products</div>
